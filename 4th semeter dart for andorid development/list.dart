...
void main(){
  ...
  // list.insert(2, 'data'); //insert data from after 2 
  // print(list);
  // print(list.length);
  // list.remove(3); //remove 3 inside all of list
  // print(list);
  ...
  // list.forEach((element) { // print Element inside the list one by one 
  //   print('$element');
  // });
  // List list1 = [2, 3, 5, 7, 3, 1, 4, 67, 8, 9, 5];
  // int data = list1.firstWhere((element) => element > 5);
  // print(data);
